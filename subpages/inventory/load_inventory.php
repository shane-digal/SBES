<div class="row">
	...
	<div class="col-xs-12 col-md-6">
		<a onclick="" href="javascript:void(0);">
			<h5 class="pull-right"><i class="fa fa-plus"></i> REGISTER ITEM&emsp;</h5>
		</a>
		...
		<div class="my-container">
			<div class="nav-tabs-custom my-nav-tabs">
				<ul class="nav nav-tabs">
					<li class="active"><a href="inventory.php"><b>INVENTORY</b></a></li>
				...
				<div class="tab-content no-padding">
					<div class="tab-pane active relative pad15" id="inventory-tab">
						<div class="row">
...
<script type="text/javascript">
	...
	function load_inventory_list(page)
	{
		var limit = $("#search_limit").val();
		var key = encodeURI($("#search_key").val());
		var project = encodeURI($("#search_project").val());

		$("#inventory-cont").load("./subpages/inventory/load_inventory_list.php?limit="+limit+"&project="+project+"&key="+key+"&page="+page);
	}

	load_inventory_list(1);
</script>