...
<script type="text/javascript">
	...
	function load_payroll_draft_list(page)
	{
		...
		$("#project-cont").load("./subpages/payroll/load_payroll_draft_list.php?limit="+limit+"&status="+status+"&daterange="+daterange+"&key="+key+"&page="+page);
	}
