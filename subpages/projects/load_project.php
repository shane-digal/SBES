<div class="row">
	...
	<div class="col-xs-12 col-md-6">
		...
		<a onclick="load_project_draft();" href="javascript:void(0);">
...
<script type="text/javascript">
	...
	function load_project_list(page)
	{
		...
		$("#project-cont").load("./subpages/projects/load_project_list.php?limit="+limit+"&status="+status+"&daterange="+daterange+"&key="+key+"&page="+page);
	}
